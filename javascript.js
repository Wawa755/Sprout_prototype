...
document.addEventListener('DOMContentLoaded', () => {
    if (document.querySelector('.Sea_Cards ')) {
        // Slider dragging
        const slider = document.querySelector('.Sea_Cards ');
        let isDown = false;
        let startX;
        let scrollLeft;
        ...
        // Scroll
        const scrollContainer = document.querySelector(".Sea_Cards");
...
document.addEventListener('DOMContentLoaded', () => {
    if (document.querySelector('.Res_Cards ')) {
        // Slider dragging
        const slider = document.querySelector('.Res_Cards ');
        let isDown = false;
        let startX;
        let scrollLeft;
        ...
        // Scroll
        const scrollContainer = document.querySelector(".Res_Cards");
